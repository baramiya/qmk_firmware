...
|        |        |        |        |        |        |        |        |        |        |        |        |        | BACK   | BACK   |  NUM   |        |        |        |
|  ~`    |   1    |   2    |   3    |   4    |   5    |   6    |   7    |   8    |   9    |   0    |  _ -   | =  +   | SPACE  | SPACE  |  LOCK  |   /    |  *     |  DEL   |
|________|________|________|________|________|________|________|________|________|________|________|________|________|________|________|________|________|________|________|
|            |        |        |        |        |        |        |        |        |        |        |  [     |   ]    |             |        |        |        |        |
...
|          |          |          |                                                        |        |   MO   |        |        |        |        |        |        |        |
| CTRL     | L ALT    |  LGUI    |                      SPACE                             |  RGUI  |  _FN   |  CTRL  |  LEFT  |  DOWN  | RIGHT  |   0    |   .    | ENTER  |
...
*/
    ...
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_BSPC, KC_NLCK, KC_PSLS, KC_PAST, KC_DEL,
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, MO(1),   KC_RCTRL,KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT),
...
*/
	...
	LAYOUT(
    RESET,   KC_BRMD, KC_BRMU, _______, _______, _______, _______, _______, _______, _______, _______, KC_MRWD, KC_MFFD, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______,
